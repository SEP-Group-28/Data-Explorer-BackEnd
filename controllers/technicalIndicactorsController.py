...
def technicalIndicactorsController(server):    
    @server.route('/rsi/<market_type>/<name>/<interval>', methods=['GET'])
    ...
    @server.route('/obv/<market_type>/<name>/<interval>', methods=['GET'])
    ...
    @server.route('/roc/<market_type>/<name>/<interval>', methods=['GET'])
    ...
    @server.route('/ema/<market_type>/<name>/<interval>', methods=['GET'])
    ...
    @server.route('/macd/<market_type>/<name>/<interval>', methods=['GET'])
